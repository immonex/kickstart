		...
		$fields = apply_filters(
			...
			array(
				...
				array(
					...
					'args'    => array(
						'description' => __( 'If active, the property marker map will be shown in the default list (archive) pages.', 'immonex-kickstart' ),
					),
				),
				array(
