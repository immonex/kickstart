...
?>
<div class="inx-form-element inx-form-element--<?php echo esc_attr( $inx_skin_element_name ); ?> uk-search uk-search-default uk-width-1-1">
	...
	<?php endif; ?>
	<input type="<?php echo 'date' === $inx_skin_type ? 'text' : esc_attr( $inx_skin_type ); ?>"
		...
		class="inx-search-input inx-search-input--type--<?php echo esc_attr( $inx_skin_type ); ?> uk-search-input">
</div>
