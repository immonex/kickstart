...
<div id="<?php echo $inx_skin_component_id; ?>" class="inx-property-map-container inx-container<?php echo ! empty( $template_data['is_preview'] ) ? ' inx-is-preview' : ''; ?>">
	<inx-property-open-layers-map
		...
		marker-fill-color="<?php echo esc_attr( $template_data['marker_fill_color'] ); ?>"
		:marker-fill-opacity="<?php echo esc_attr( $template_data['marker_fill_opacity'] ); ?>"
		marker-stroke-color="<?php echo esc_attr( $template_data['marker_stroke_color'] ); ?>"
		...
		force-lang="<?php echo ! empty( $template_data['inx-force-lang'] ) ? esc_attr( $template_data['inx-force-lang'] ) : ''; ?>"
